...
describe('MediaLibrary', () => {
  ...
  describe('6.1.5 测试文件夹显示', () => {
    ...
    it('should show delete button on folder hover', () => {
      ...
      const folderElement = screen.getByText(/新建文件夹_/).closest('div')?.parentElement as HTMLElement;
  ...
  describe('6.1.10 测试删除功能', () => {
    ...
    it('should delete file when delete button clicked', async () => {
      ...
      const fileElement = screen.getByText('video.mp4').closest('div')?.parentElement as HTMLElement;
