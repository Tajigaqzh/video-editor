...
describe("ContextMenu", () => {
  ...
  describe("空白区域菜单渲染", () => {
    it("should render blank area menu with correct items", () => {
      render(<ContextMenu x={100} y={100} onAction={mockOnAction} onClose={mockOnClose} />);
    ...
    it("should render menu with proper styling", () => {
      const { container } = render(
        <ContextMenu x={100} y={100} onAction={mockOnAction} onClose={mockOnClose} />,
      );
  ...
  describe("菜单位置定位", () => {
    it("should position menu at correct coordinates", () => {
      const { container } = render(
        <ContextMenu x={150} y={200} onAction={mockOnAction} onClose={mockOnClose} />,
      );
    ...
    it("should position menu at different coordinates", () => {
      const { container } = render(
        <ContextMenu x={300} y={450} onAction={mockOnAction} onClose={mockOnClose} />,
      );
    ...
    it("should position menu at zero coordinates", () => {
      const { container } = render(
        <ContextMenu x={0} y={0} onAction={mockOnAction} onClose={mockOnClose} />,
      );
